...
// ou do componente que realmente usa
...
export default class Jogo extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            valorFinal: 10,
            //variável que controla o tempo que resta para o usuário resolver o desafio exibida atualmente.
            tempoRestante: 5
        }
    }
    timerGeral = null
...
const styles = {
    ...
    valor:
        'flex justify-content-center align-items-center border-round border-1 border-400 h-3rem w3rem',
    // outline no botão
    alternativa:
        'p-button-outlined',
